return function()
    ...
    vim.keymap.set("n", "<leader>ct", "<cmd>cw<cr>", { desc = "Toggle List" })
    vim.keymap.set("n", "<leader>cn", "<cmd>cn<cr>", { desc = "Next Location" })
    vim.keymap.set("n", "<leader>cp", "<cmd>cp<cr>", { desc = "Previous Location" })

    -- Concealing
    vim.keymap.set("n", "<leader>ce", "<cmd>set conceallevel=2<cr>", { desc = "Enable Concealing" })
    vim.keymap.set("n", "<leader>cd", "<cmd>set conceallevel=0<cr>", { desc = "Disable Concealing" })
